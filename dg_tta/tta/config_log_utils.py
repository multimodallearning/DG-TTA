...
def get_tta_folders(pretrained_dataset_id, tta_dataset_id, pretrainer, pretrainer_config, pretrainer_fold):
    ...
    return tta_data_dir, plan_dir, results_dir, pretrained_dataset_name, tta_dataset_name

def prepare_tta(pretrained_dataset_id, tta_dataset_id,
    ...
    assert (
        pretrained_dataset_id in ['TS104_GIN', 'TS104_MIND', 'TS104_GIN_MIND'] \
    ...
    # Create directories
    _, plan_dir, results_dir, pretrained_dataset_name, tta_dataset_name = \
        get_tta_folders(pretrained_dataset_id, tta_dataset_id, pretrainer, pretrainer_config, pretrainer_fold)
    ...
    if isinstance(pretrained_dataset_id, str):
        ...
        results_pretrained_dataset_dir = Path(nnUNet_results, pretrained_dataset_name,
